<%-- 
    Document   : employeesInShift
    Created on : 12 Ιαν 2021, 1:32:35 πμ
    Author     : kater
--%>
...
<html lang="en">
    <head>
        ...
        <title>Show employees'in shift list</title>
        <style>
            #empl {
    ...
    <body onload="EmployeesInShift()">
        <div class="box">
            <h1>Λίστα υπαλλήλων που είναι τώρα σε βάρδια</h1>
            </br>
            <table id="empl">
                <tr>
                    <th>EMPLOYEE_ID</th>
