<%-- 
    Document   : NurseExam
    Created on : 12 Ιαν 2021, 9:43:31 μμ
    Author     : kater
--%>
...
<html lang="en">
    ...
    <body>
        <form class="box" method="post" action="http://localhost:8080/Project360/newFormExamNurse" >
            <h1>Εγγραφή νέας εξέτασης από τον νοσοκόμο</h1>
            <table>
                <tr>
